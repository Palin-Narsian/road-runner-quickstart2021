...
@Autonomous
public class RedOneWobble extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory shortForwardA = drive.trajectoryBuilder(targetZoneA.end(), true)
                .splineTo(new Vector2d(3, -58), Math.toRadians(0))
                .build();
        Trajectory shortBackwardA = drive.trajectoryBuilder(shortForwardA.end())
                .splineTo(new Vector2d(-5, -58), Math.toRadians(0))
                .build();
        Trajectory ParkA = drive.trajectoryBuilder(shortBackwardA.end(), true)
...
//      Target B
        ...
        Trajectory Park = drive.trajectoryBuilder(shortForwardC.end())
