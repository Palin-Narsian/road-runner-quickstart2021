...
@Autonomous
public class RedShootTwoWobbleB extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory lineUpB = drive.trajectoryBuilder(targetZoneB.end())
                .splineTo(new Vector2d(-20, -8), Math.toRadians(27))
                .build();
        Trajectory goForSecondWobbleB = drive.trajectoryBuilder(lineUpB.end())
                .lineToConstantHeading(new Vector2d(-37, -25.9), new MinVelocityConstraint(
                                Arrays.asList(
        ...
        Trajectory secondTargetZoneB = drive.trajectoryBuilder(lineUpToDropSecondWobbleB.end(), true)
                .splineTo(new Vector2d(25, -27), Math.toRadians(-10))
                .build();
